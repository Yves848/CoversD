...
const
    ...
    NAME_TagsLibrary_AddCoverArtFromFile    = 'TagsLibrary_AddCoverArtFromFile';
    ...
    NAME_TagsLibrary_GetCoverArtBitmapHandle = 'TagsLibrary_GetCoverArtBitmapHandle';
    NAME_TagsLibrary_AddCoverArtFromFileAutomatic = 'TagsLibrary_AddCoverArtFromFileAutomatic';
    NAME_TagsLibrary_FixWAVEFile            = 'TagsLibrary_FixWAVEFile';
    NAME_TagsLibrary_GetWAVEVNT             = 'TagsLibrary_GetWAVEVNT';
...
Const
    ...
    TAGSLIBRARY_PARSE_COVER_ARTS                                    = 8;
    TAGSLIBRARY_PARSE_AUDIO_ATTRIBUTES                              = 9;    
    TAGSLIBRARY_ID3v1_RETURN_ANSI_TEXT                              = 10;
    TAGSLIBRARY_ID3v2_RETURN_ANSI_TEXT                              = 11;
...
type
    ...
    TMPEGAudioAttributes = packed record
        ...
        SampleCount: Int64;             //* Total number of samples
        PlayTime: Double;               //* Total playtime
    end;
...
type
    ...
    t_TagsLibrary_AddCoverArtFromFile   = function (Tags: HTags; TagType: TTagType; FileName: PChar; var CoverArt: TCoverArtData): LongBool; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
    ...
    t_TagsLibrary_GetCoverArtBitmapHandle = function(Tags: HTags; TagType: TTagType; Index: Integer; var CoverArt: TCoverArtData; var BitmapHandle: THandle; Width: Integer; Height: Integer; KeepAspectRatio: LongBool; Resampler: Integer; Handle: THandle): LongBool; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
    t_TagsLibrary_AddCoverArtFromFileAutomatic = function(Tags: HTags; TagType: TTagType; FileName: PChar; Name: PChar; Description: PChar; CoverType: Integer; Handle: THandle): Integer; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
    t_TagsLibrary_FixWAVEFile           = function (FileName: PChar): Integer; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
    t_TagsLibrary_GetWAVEVNT            = function (Tags: HTags; Index: Integer; var SPEVENT: TSPEVENT): Integer; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
...
var
    ...
    TagsLibrary_AddCoverArtFromFile: t_TagsLibrary_AddCoverArtFromFile;
    ...
    TagsLibrary_GetCoverArtBitmapHandle: t_TagsLibrary_GetCoverArtBitmapHandle;
    TagsLibrary_AddCoverArtFromFileAutomatic: t_TagsLibrary_AddCoverArtFromFileAutomatic;
    TagsLibrary_FixWAVEFile: t_TagsLibrary_FixWAVEFile;
    TagsLibrary_GetWAVEVNT: t_TagsLibrary_GetWAVEVNT;
...
begin
    ...
    if Result then begin
        ...
        TagsLibrary_AddCoverArtFromFile := GetProcAddress(TagsLibraryHandle, PWideChar(NAME_TagsLibrary_AddCoverArtFromFile));
        ...
        TagsLibrary_GetCoverArtBitmapHandle := GetProcAddress(TagsLibraryHandle, PWideChar(NAME_TagsLibrary_GetCoverArtBitmapHandle));
        TagsLibrary_AddCoverArtFromFileAutomatic := GetProcAddress(TagsLibraryHandle, PWideChar(NAME_TagsLibrary_AddCoverArtFromFileAutomatic));
        TagsLibrary_FixWAVEFile         := GetProcAddress(TagsLibraryHandle, PWideChar(NAME_TagsLibrary_FixWAVEFile));
        TagsLibrary_GetWAVEVNT          := GetProcAddress(TagsLibraryHandle, PWideChar(NAME_TagsLibrary_GetWAVEVNT));
    end;
    ...
    OR (@TagsLibrary_AddCoverArtFromFile = nil)
    ...
    OR (@TagsLibrary_GetCoverArtBitmapHandle = nil)
    OR (@TagsLibrary_AddCoverArtFromFileAutomatic = nil)
    OR (@TagsLibrary_FixWAVEFile = nil)
    OR (@TagsLibrary_GetWAVEVNT = nil)
    then begin
