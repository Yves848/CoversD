...
type
    TReadMemoryStream = class (TCustomMemoryStream)
        Constructor Create(Address: Pointer; MemorySize: NativeInt);
...
constructor TReadMemoryStream.Create(Address: Pointer; MemorySize: NativeInt);
begin
    inherited Create;
    SetPointer(Address, MemorySize);
end;
