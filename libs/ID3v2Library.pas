//********************************************************************************************************************************
//*                                                                                                                              *
//*     ID3v2 Library 2.0.69.175 © 3delite 2010-2019                                                                             *
...
Const
    ID3V2LIBRARY_VERSION = $020069175;
...
Const
    ...
    ID3V2LIBRARY_DEFAULT_MPEG_SEARCH_LENGTH = 4096; //* Increasing this value helps for corrupted MPEG files, but increses false MPEG sync detection
...
type
    ...
    public
        ...
        Constructor Create(_Parent: TID3v2Tag);
        Destructor Destroy; override;
    ...
    private
        ...
        function MPEGValidHeader(MPEGStream: TStream): Boolean;
    ...
    public
        ...
        function CalculateTagSize(_PaddingSize: Integer): Integer;
...
Constructor TID3v2Frame.Create(_Parent: TID3v2Tag);
begin
    Inherited Create;
    Parent := _Parent;
    //ID := '';
...
begin
    ...
    //ReturnANSIText := ID3v2LibraryDefaultReturnANSIText;
...
function TID3v2Tag.LoadFrame(Stream: TStream): Boolean;
var
    FrameID: TFrameID;
    FrameIndex: Integer;
    ValidFrame: Boolean;
...
procedure TID3v2Tag.LoadFrameData(Stream: TStream; FrameIndex: Integer);
var
    FrameSize: DWord;
    FrameFlags: Word;
...
begin
    ...
    //Result := NewFrame.Index;
end;

function TID3v2Tag.AddFrame(const FrameID: String): Integer;
var
    ID: TFrameID;
begin
...
function TID3v2Tag.DeleteFrame(const FrameID: String): Boolean;
var
    ID: TFrameID;
begin
    AnsiStringToPAnsiChar(FrameID, ID);
...
function TID3v2Tag.FrameExists(const FrameID: String): Integer;
var
    i: Integer;
...
function TID3v2Tag.FrameTypeCount(const FrameID: String): Integer;
var
    ID: TFrameID;
begin
...
function TID3v2Tag.GetUnicodeText(const FrameID: String; ReturnNativeText: Boolean = False): String;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUnicodeText(const FrameID: String; const Text: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUnicodeText(FrameIndex: Integer; const Text: String): Boolean;
var
    Data: Byte;
begin
    Result := False;
...
function TID3v2Tag.SetText(const FrameID: String; const Text: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetText(FrameIndex: Integer; const Text: String): Boolean;
var
    Data: Byte;
    Bytes: TBytes;
begin
...
function TID3v2Tag.SetUTF8Text(const FrameID: String; const Text: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetUTF8Text(FrameIndex: Integer; const Text: String): Boolean;
var
    Data: Byte;
    Bytes: TBytes;
begin
...
function TID3v2Tag.SetRawText(const FrameID: String; const Text: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetRawText(FrameIndex: Integer; const Text: String): Boolean;
var
    Data: Byte;
    Bytes: TBytes;
begin
...
function TID3v2Tag.SetGEOB(FrameID, MIMEType, EncapsulatedObjectFilename, ContentDescription: String; EncapsulatedObject: TBytes): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetOWNE(FrameIndex: Integer; PricePaid: String; DateOfPurchase: TDate; Seller: String): Boolean;
var
...
function TID3v2Tag.SetOWNE(FrameID, PricePaid: String; DateOfPurchase: TDate; Seller: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetOWNE(FrameIndex: Integer; PricePaid, DateOfPurchase, Seller: String): Boolean;
var
    DataByte: Byte;
...
function TID3v2Tag.SetOWNE(FrameID, PricePaid, DateOfPurchase, Seller: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetGEOB(FrameIndex: Integer; MIMEType, EncapsulatedObjectFilename, ContentDescription: String; EncapsulatedObject: TBytes): Boolean;
var
    DataByte: Byte;
    DataWord: Word;
...
function TID3v2Tag.GetUnicodeCoverPictureInfo(FrameID: String; var MIMEType: String; var Description: String; var CoverType: Integer; Bytes: PBytes = nil): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetUnicodeCoverPictureInfo(FrameIndex: Integer; var MIMEType: String; var Description: String; var CoverType: Integer; Bytes: PBytes = nil): Boolean;
var
    DataByte: Byte;
    Encoding: Byte;
...
function TID3v2Tag.GetCoverPictureInfoPointer(FrameIndex: Integer; var Data: Pointer; var DataSize: Int64; var MIMEType: Pointer; var Description: Pointer; var Encoding: Integer; var CoverType: Integer): Boolean;
var
    DataByte: Byte;
    DataWord: Word;
begin
...
function TID3v2Tag.GetGEOB(FrameID: String; var MIMEType, EncapsulatedObjectFilename, ContentDescription: String): TBytes;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetGEOB(FrameIndex: Integer; var MIMEType, EncapsulatedObjectFilename, ContentDescription: String): TBytes;
var
    Encoding: Byte;
    BigEndian: Boolean;
    DataSize: Int64;
...
function TID3v2Tag.GetUSER(FrameIndex: Integer; var LanguageID: TLanguageID): String;
var
    Encoding: Byte;
begin
    Result := '';
...
function TID3v2Tag.GetUSER(FrameID: String; var LanguageID: TLanguageID): String;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.CheckValidFrame(FrameIndex: Integer): TID3v2FrameErrors;
var
    Encoding: Byte;
begin
    Result := [];
...
function TID3v2Tag.SetUSER(FrameIndex: Integer; LanguageID: TLanguageID; TermsOfUse: String): Boolean;
var
    DataByte: Byte;
...
function TID3v2Tag.SetUSER(FrameID: String; LanguageID: TLanguageID; TermsOfUse: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.CalculateTagSize(_PaddingSize: Integer): Integer;
var
    ...
    repeat
        ...
        if Data = $FF then begin
            ...
            then begin
                ...
                if MPEGValidHeader(MPEGStream) then begin
                    Result := True;
                    Exit;
                end;
                MPEGStream.Seek(2, soCurrent);
...
function TID3v2Tag.WriteAllFrames(Stream: TStream): Integer;
var
    i: Integer;
...
function TID3v2Tag.GetSEBR(FrameID: String): {$IFDEF WIN64}Double{$ELSE}Extended{$ENDIF};
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetSEBR(FrameIndex: Integer): {$IFDEF WIN64}Double{$ELSE}Extended{$ENDIF};
var
    {$IFNDEF WIN64}
    SEBR: Extended;
    {$ENDIF}
...
function TID3v2Tag.SetSEBR(FrameID: String; BitRateStr: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetSEBR(FrameIndex: Integer; BitRateStr: String): Boolean;
var
    Data: Byte;
    i: Integer;
    {$IFNDEF WIN64}
...
function TID3v2Tag.SetSEBR(FrameID: String; BitRateValue: Extended): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.SetSEBR(FrameIndex: Integer; BitRateValue: Extended): Boolean;
var
    StrSEBR: String;
    i: Integer;
    Data: Byte;
...
function TID3v2Tag.SetAENC(FrameIndex: Integer; OwnerIdentifier: String; PreviewStart, PreviewLength: Word; EncryptionInfo: TBytes): Boolean;
var
...
function TID3v2Tag.SetAENC(FrameID: String; OwnerIdentifier: String; PreviewStart, PreviewLength: Word; EncryptionInfo: TBytes): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetFrameCount: Int64;
begin
    Result := Frames.Count;
end;

function TID3v2Tag.GetFrameIndexOfCoverArtIndex(CoverArtIndex: Integer): Integer;
var
    i: Integer;
    Counter: Integer;
begin
...
function TID3v2Tag.GetUnicodeListFrameText(FrameIndex: Integer): String;
var
    Encoding: Byte;
    BigEndian: Boolean;
    NilFound: Boolean;
...
function TID3v2Tag.GetUFIDBytes(FrameIndex: Integer; var OwnerIdentifier: String): TBytes;
var
    DataSize: Int64;
begin
    Result := nil;
...
function TID3v2Tag.MPEGValidHeader(MPEGStream: TStream): Boolean;
var
    Data: Byte;
    Header: Longword;
    TmpHdr: Longword;
...
function TID3v2Tag.GetBytes(FrameIndex: Integer): TBytes;
var
    DataSize: Int64;
begin
    SetLength(Result, 0);
...
function TID3v2Tag.GetAENC(FrameIndex: Integer; var OwnerIdentifier: String; var PreviewStart, PreviewLength: Word): TBytes;
var
    DataWord: Word;
    DataSize: Int64;
begin
...
function TID3v2Tag.GetAENC(FrameID: String; var OwnerIdentifier: String; var PreviewStart, PreviewLength: Word): TBytes;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetOWNE(FrameIndex: Integer; var PricePaid, DateOfPurchase, Seller: String): Boolean;
var
    Encoding: Byte;
    i: Integer;
    DataByte: Byte;
...
function TID3v2Tag.GetOWNE(FrameID: String; var PricePaid, DateOfPurchase, Seller: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
...
function TID3v2Tag.GetOWNE(FrameIndex: Integer; var PricePaid: String; var DateOfPurchase: TDate; var Seller: String): Boolean;
var
    DateOfPurchaseStr: String;
    DecodeError: Boolean;
begin
...
function TID3v2Tag.GetOWNE(FrameID: String; var PricePaid: String; var DateOfPurchase: TDate; var Seller: String): Boolean;
var
    Index: Integer;
    ID: TFrameID;
begin
